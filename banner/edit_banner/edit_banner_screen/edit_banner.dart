...
//     existingImages = List<String>.from(banner['images']);
...
//             children: [
//               CustomTextFormField(
//                   controller: bannerNameController, labelText: 'Banner Name'),
...
//               // Display newly selected images with remove option
...
//       body: BlocListener<EditBannerBloc, EditBannerState>(
//         listener: (context, state) {
//           if (state is EditBannerImageUpdated) {
//             ScaffoldMessenger.of(context)
//                 .showSnackBar(SnackBar(content: Text(state.message)));
//             context.read<EditBannerBloc>().add(LoadEditBannersEvent());
//           }
//         },
//         child: BlocBuilder<EditBannerBloc, EditBannerState>(
...
//                         ? Image.memory(base64Decode(banner['images'][0]),
...
//                             context
//                                 .read<EditBannerBloc>()
//                                 .add(DeleteEditBannerEvent(banner['id']));
//                           },
//                         ),
//                       ],
//                     ),
